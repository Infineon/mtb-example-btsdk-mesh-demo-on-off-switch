...
- Control of a BLE Mesh light bulb using BLE Mesh On/Off messages

## Instructions
To demonstrate the app, work through the following steps:

1. Build and download the application to the WICED Kit
2. Build and download the BLE Mesh LightDimmable application to another WICED Kit
